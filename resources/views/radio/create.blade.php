{{-- resources/views/radio/create.blade.php --}}
@extends('layouts.app')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
                <h1 class="text-2xl font-bold text-white">Tambah Data Radio Baru</h1>
                <p class="text-blue-100 mt-1">Lengkapi formulir di bawah ini</p>
            </div>

            <form action="{{ route('radio.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_radio" value="{{ old('nama_radio') }}"
...
{{-- Same structure as create.blade.php but with route to radio.update and method @method('PUT') --}}